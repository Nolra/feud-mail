$( document ).ready(function() {
	...
	let userMail = [
		mail = { 
			...
			title : "Будешь пиво?",
			star : "",
			text : "Привет. Я недавно только узнал, что произошло. В это сложно поверить и это невероятно грустно.<br><br> Я поговорил с Сашей и Олесей, они рассказали как много ты сейчас делаешь, спасибо тебе. Если хочешь поговорить, то можем созвониться. Главное, держись."
		},
		mail = { 
		...
		mail = { 
			...
			star : "star",
			text : "Активист Павел Крисевич устроил акцию «в поддержку политзаключенных» около здания ФСБ в Москве. <br><br> Его подвесили на крест в образе Иисуса Христа, облили жидкостью и «подожгли», бросая в огонь тома уголовных дел. Крисевеч известен своими акциями: в частности, на приговоре фигурантам «дела Сети*» в Петербурге летом этого года он приковал себя наручниками у здания военного суда, поджог фаер и стал раскидывать листовки. На приговоре фигурантам дела «Нового величия» (считается в России экстремистской организацией) Крисевеч надел милицейскую форму и «вскрыл горло» манекену, забрызгав ступени суда кровью. Во время протестов в Беларуси «повесился» на тросе на Троицком мосту в Петербурге и спрыгнул в воду в знак солидарности с протестующими республики. *считается запрещенной в России террористической организацией. Видео Георгия Маркова"
		},
		mail = { 
